...
export const REGIONAL_RSS_SOURCES = [
  { name: 'ABP Majha', state: 'Maharashtra', url: 'https://news.google.com/rss/search?q=ABP+Majha+OR+Maharashtra+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://marathi.abplive.com' },
  { name: 'NDTV', state: 'Delhi', url: 'https://news.google.com/rss/search?q=NDTV+Delhi+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.ndtv.com' },
  { name: 'TV9 Kannada', state: 'Karnataka', url: 'https://news.google.com/rss/search?q=TV9+Kannada+OR+Karnataka+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://tv9kannada.com' },
  { name: 'Oneindia Tamil', state: 'Tamil Nadu', url: 'https://news.google.com/rss/search?q=Oneindia+Tamil+OR+Tamil+Nadu+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://tamil.oneindia.com' },
  { name: 'TV9 Telugu', state: 'Andhra Pradesh', url: 'https://news.google.com/rss/search?q=TV9+Telugu+OR+Andhra+Pradesh+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://tv9telugu.com' },
  { name: 'V6 News', state: 'Telangana', url: 'https://news.google.com/rss/search?q=V6+News+OR+Telangana+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.v6velugu.com' },
  { name: 'Amar Ujala Uttar Pradesh', state: 'Uttar Pradesh', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Uttar+Pradesh+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' },
  { name: 'ABP Ananda', state: 'West Bengal', url: 'https://news.google.com/rss/search?q=ABP+Ananda+OR+West+Bengal+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://bengali.abplive.com' },
  { name: 'Asianet News', state: 'Kerala', url: 'https://news.google.com/rss/search?q=Asianet+News+OR+Kerala+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.asianetnews.com' },
  { name: 'TV9 Gujarati', state: 'Gujarat', url: 'https://news.google.com/rss/search?q=TV9+Gujarati+OR+Gujarat+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://tv9gujarati.com' },
  { name: 'Amar Ujala Rajasthan', state: 'Rajasthan', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Rajasthan+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' },
  { name: 'Amar Ujala Punjab', state: 'Punjab', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Punjab+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' },
  { name: 'Amar Ujala Haryana', state: 'Haryana', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Haryana+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' },
  { name: 'Amar Ujala Bihar', state: 'Bihar', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Bihar+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' },
  { name: 'IBC24', state: 'Madhya Pradesh', url: 'https://news.google.com/rss/search?q=IBC24+OR+Madhya+Pradesh+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.ibc24.in' },
  { name: 'Arunachal Today', state: 'Arunachal Pradesh', url: 'https://news.google.com/rss/search?q=Arunachal+Today+OR+Arunachal+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://arunachaltoday.in' },
  { name: 'News Live', state: 'Assam', url: 'https://news.google.com/rss/search?q=News+Live+OR+Assam+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://newslive.com' },
  { name: 'IBC24', state: 'Chhattisgarh', url: 'https://news.google.com/rss/search?q=IBC24+OR+Chhattisgarh+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.ibc24.in' },
  { name: 'Prudent Media', state: 'Goa', url: 'https://news.google.com/rss/search?q=Prudent+Media+OR+Goa+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.prudentmedia.in' },
  { name: 'Amar Ujala Himachal Pradesh', state: 'Himachal Pradesh', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Himachal+Pradesh+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' },
  { name: 'Zee Bihar Jharkhand', state: 'Jharkhand', url: 'https://news.google.com/rss/search?q=Zee+Bihar+Jharkhand+OR+Jharkhand+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://zeehar.com' },
  { name: 'Impact TV', state: 'Manipur', url: 'https://news.google.com/rss/search?q=Impact+TV+OR+Manipur+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.impacttv.in' },
  { name: 'Batesi TV', state: 'Meghalaya', url: 'https://news.google.com/rss/search?q=Batesi+TV+OR+Meghalaya+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://batesitv.com' },
  { name: 'Zonet Cable TV', state: 'Mizoram', url: 'https://news.google.com/rss/search?q=Zonet+Cable+TV+OR+Mizoram+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://zonet.in' },
  { name: 'Hornbill TV', state: 'Nagaland', url: 'https://news.google.com/rss/search?q=Hornbill+TV+OR+Nagaland+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://hornbilltv.com' },
  { name: 'OTV (Odisha TV)', state: 'Odisha', url: 'https://news.google.com/rss/search?q=OTV+OR+Odisha+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://odishatv.in' },
  { name: 'Sikkim Chronicle', state: 'Sikkim', url: 'https://news.google.com/rss/search?q=Sikkim+Chronicle+OR+Sikkim+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://sikkimchronicle.com' },
  { name: 'Headlines Tripura', state: 'Tripura', url: 'https://news.google.com/rss/search?q=Headlines+Tripura+OR+Tripura+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://headlinestripura.com' },
  { name: 'Amar Ujala Uttarakhand', state: 'Uttarakhand', url: 'https://news.google.com/rss/search?q=Amar+Ujala+OR+Uttarakhand+news&hl=en-IN&gl=IN&ceid=IN:en', sourceUrl: 'https://www.amarujala.com' }
];
